...
////GameMap
/////plsocket
#ifndef TOLUA_DISABLE_tolua_Cocos2d_GameMap_init
int tolua_Cocos2d_GameMap_init(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
	tolua_Error tolua_err;
	if (
		!tolua_isusertable(tolua_S,1,"cc.GameMap",0,&tolua_err) ||
		!tolua_isstring(tolua_S, 2, 0, &tolua_err)
		//!tolua_isnoobj(tolua_S,5,&tolua_err)
		)
		goto tolua_lerror;
...
#endif
	{
		...
		if(lua_isboolean(tolua_S, 3)){
			isSetPath = lua_toboolean(tolua_S, 3);
		}
		if(!ok){
			return 0;
		}
		return GameMap::initWithFile(tolua_S, filename.c_str(), isSetPath);		
	}

#ifndef TOLUA_RELEASE
tolua_lerror:
	tolua_error(tolua_S,"#ferror in function 'GameMap_init'.",&tolua_err);
	return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
///MapAstar
#ifndef TOLUA_DISABLE_tolua_Cocos2d_MapAstar_getInstance
int tolua_Cocos2d_MapAstar_getInstance(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
	tolua_Error tolua_err;
	if (
		!tolua_isusertable(tolua_S,1,"cc.MapAstar",0,&tolua_err)
		//!tolua_isnoobj(tolua_S,5,&tolua_err)
		)
		goto tolua_lerror;
	else
#endif
	{
		MapAstar* ret = MapAstar::getInstance();
		if(ret){
			object_to_luaval<MapAstar>(tolua_S, "cc.MapAstar",ret);
			return 1;
		}
		return 0;
	}
...
#ifndef TOLUA_RELEASE
tolua_lerror:
	tolua_error(tolua_S,"#ferror in function 'MapAstar_getInstance'.",&tolua_err);
	return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
#ifndef TOLUA_DISABLE_tolua_Cocos2d_MapAstar_setMapdata
int tolua_Cocos2d_MapAstar_setMapdata(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
	tolua_Error tolua_err;
	if (
		!tolua_isusertype(tolua_S,1,"cc.MapAstar",0,&tolua_err) ||
		!tolua_isstring(tolua_S, 2, 0, &tolua_err) ||
		!tolua_isnumber(tolua_S, 3, 0, &tolua_err) ||
...
#endif
	{
		MapAstar* ret = (MapAstar*)tolua_tousertype(tolua_S, 1, NULL);	
		size_t size = 0;
		const char* data = lua_tolstring(tolua_S, 2, &size);
		int tileRow = lua_tonumber(tolua_S, 3);
		int tileCol = lua_tonumber(tolua_S, 4);
		CCASSERT(size == tileRow * tileCol, "map data args error");
		bool ok = false;
		if(ret){
			ok = ret->setMapdata(data, tileRow, tileCol);
		}
		lua_pushboolean(tolua_S, ok ? 1 : 0);
		return 1;
	}
...
#ifndef TOLUA_RELEASE
tolua_lerror:
	tolua_error(tolua_S,"#ferror in function 'MapAstar_setMapdata'.",&tolua_err);
	return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

#ifndef TOLUA_DISABLE_tolua_Cocos2d_MapAstar_findPath
int tolua_Cocos2d_MapAstar_findPath(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
	tolua_Error tolua_err;
	if (
	...
	{
		MapAstar* ret = (MapAstar*)tolua_tousertype(tolua_S, 1, NULL);	
		int startx = lua_tonumber(tolua_S, 2);
		int starty = lua_tonumber(tolua_S, 3);
		int endx = lua_tonumber(tolua_S, 4);
		int endy = lua_tonumber(tolua_S, 5);
		int direction = 8;
		if(lua_isnumber(tolua_S, 6)){
			direction = lua_tonumber(tolua_S, 6);
		}

		vector<int> vec;
		bool isFind = false;
		if(ret){
			isFind = ret->findPath(startx, starty, endx, endy, direction);
			if(isFind){
				ret->getPath(&vec);
			}
		}

		lua_pushboolean(tolua_S, isFind ? 1 : 0);
		if(isFind)
			ccvector_int_to_luaval(tolua_S, vec);
		return isFind ? 2 : 1;
	}

#ifndef TOLUA_RELEASE
tolua_lerror:
	tolua_error(tolua_S,"#ferror in function 'MapAstar_findPath'.",&tolua_err);
	return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
int lua_register_cocos2dx_CCGameMap(lua_State* tolua_S)
{
	tolua_usertype(tolua_S,"cc.GameMap");
	tolua_cclass(tolua_S,"GameMap","cc.GameMap","cc.Ref",nullptr);
	tolua_beginmodule(tolua_S,"GameMap");
		tolua_function(tolua_S,"init",tolua_Cocos2d_GameMap_init);
	tolua_endmodule(tolua_S);
	std::string typeName = typeid(GameMap).name();
	g_luaType[typeName] = "cc.GameMap";
	g_typeCast["GameMap"] = "cc.GameMap";
	return 1;
}

int lua_register_cocos2dx_CCMapAstar(lua_State* tolua_S)
{
	tolua_usertype(tolua_S,"cc.MapAstar");
	tolua_cclass(tolua_S, "MapAstar", "cc.MapAstar", "cc.Ref", nullptr);
	tolua_beginmodule(tolua_S,"MapAstar");
		tolua_function(tolua_S,"setMapdata",tolua_Cocos2d_MapAstar_setMapdata);
		tolua_function(tolua_S,"findPath",tolua_Cocos2d_MapAstar_findPath);
		tolua_function(tolua_S,"getInstance",tolua_Cocos2d_MapAstar_getInstance);
	tolua_endmodule(tolua_S);
	std::string typeName = typeid(MapAstar).name();
	g_luaType[typeName] = "cc.MapAstar";
	g_typeCast["MapAstar"] = "cc.MapAstar";
	return 1;
}
...
static bool initDefaultFont()
{
	...
	if(!fontData)
	{
		fontData = FileUtils::getInstance()->getFileData("res/fonts/MicrosoftYaHei.ttf", "rb", &size);
	}
	//default font
...
static int createHtmlFont(lua_State* ls){
	...
	string fontAlias = "font" + fontsize;
...
TOLUA_API int CustomLuaCocos2d(lua_State* tolua_S)
{
	...
	lua_register(tolua_S, "getTimer", msNow);
	...
	tolua_beginmodule(tolua_S,"cc");
		...
		lua_register_cocos2dx_CCGameMap(tolua_S);
		lua_register_cocos2dx_CCMapAstar(tolua_S);
